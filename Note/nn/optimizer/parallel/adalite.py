...
class Adalite(optimizer.Optimizer):
    ...
    def build(self, var_list):
        ...
        if self.built:
            ...
            self.v_avg_1 = self.manager.list(self.v_avg_1)
            self.m_avg_c = self.manager.list(self.m_avg_c)
            self.m_avg_r = self.manager.list(self.m_avg_r)
        ...
        self.v_avg_1 = self.manager.list()
    ...
    def update_step(self, gradient, variable, learning_rate):
        ...
        v_avg = v / (1.0 - self.beta2 ** self.step[0])
