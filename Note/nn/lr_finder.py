...
class LRFinder:
    """
    Plots the change of the loss function of a Note model when the learning rate is exponentially increasing.
    See for details:
...
class LRFinder_rl:
    """
    Plots the change of the loss function of a Note agent when the learning rate is exponentially increasing.
    See for details:
    https://towardsdatascience.com/estimating-optimal-learning-rate-for-a-deep-neural-network-ce32f2556ce0
    """
    ...
    def find(self, train_loss=None, pool_network=True, processes=None, processes_her=None, processes_pr=None, strategy=None, random=True, num_updates=None, N=None, window_size=None, start_lr=None, end_lr=None, episodes=1, metrics='reward', smooth_f=0.05, diverge_th=5, jit_compile=True):
