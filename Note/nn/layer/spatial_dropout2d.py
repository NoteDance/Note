...
class spatial_dropout2d:
    ...
    This layer randomly sets 2D feature maps along the last two dimensions to zero with a
    ...
    Call arguments:
        ...
        train_flag: A Python boolean indicating whether to apply dropout to the inputs or not. 
            If True, the layer will randomly set 2D feature maps to zero with a frequency of rate. 
