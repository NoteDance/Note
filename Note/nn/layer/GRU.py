...
class GRU:
    def __init__(self,weight_shape,weight_initializer='Xavier',bias_initializer='zero',dtype='float32',return_sequence=False,use_bias=True,activation1=tf.nn.sigmoid,activation2=tf.nn.tanh):
