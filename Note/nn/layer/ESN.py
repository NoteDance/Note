...
class ESN:
    def __init__(self, weight_shape, connectivity=0.1, leaky=1.0, spectral_radius=0.9, use_norm2=False, use_bias=True, activation='tanh', weight_initializer='uniform', bias_initializer='zero', dtype='float64'):
