...
class conv2d_transpose: # define a class for 2D transposed convolutional layer
    def __init__(self,filters,kernel_size,input_size=None,new_rc=None,strides=[1,1],padding='VALID',weight_initializer='Xavier',bias_initializer='zeros',activation=None,data_format='NHWC',dilations=None,use_bias=True,trainable=True,dtype='float32'): # define the constructor method
        ...
        self.dtype=dtype
        self.new_rc=new_rc # set the new row and column numbers of the output tensor after transposed convolution
