...
class bottleneck:
    def __init__(self,input_dim,output_dim,bottleneck_dim,weight_initializer='Xavier',bias_initializer='zero',activation='relu',dtype='float32',use_bias=True):
        ...
        if use_bias==True:
            self.weight_list=[self.weight_1,self.bias_1,self.weight_2,self.bias_2]
        else:
            self.weight_list=[self.weight_1,self.weight_2]
