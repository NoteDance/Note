...
class sparse_attention:
    def __init__(self,input_dim,output_dim,num_heads,weight_initializer='Xavier',bias_initializer='zero',activation='relu',dtype='float32',use_bias=True):
        ...
        if use_bias==True:
            self.weight_list=self.weight_Q+self.bias_Q+self.weight_K+self.bias_K+self.weight_V+self.bias_V
        else:
            self.weight_list=self.weight_Q+self.weight_K+self.weight_V
