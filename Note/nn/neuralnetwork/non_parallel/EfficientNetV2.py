...
class EfficientNetV2:
    ...
    def build(self):
        ...
        self.layers1.add(batch_normalization(axis=-1,momentum=self.bn_momentum,parallel=False,dtype=self.dtype))
        ...
        self.layers3.add(batch_normalization(axis=-1,momentum=self.bn_momentum,parallel=False,dtype=self.dtype))
