...
class _inverted_res_block:
    def __init__(self, in_channels=None, expansion=None, stride=None, alpha=None, filters=None, block_id=None, dtype='float32'):
        ...
        self.batch_normalization1=batch_normalization(self.conv2d1.output_size,momentum=0.999,parallel=False,dtype=dtype)
        ...
        self.batch_normalization2=batch_normalization(self.depthwiseconv2d.output_size,momentum=0.999,parallel=False,dtype=dtype)
        ...
        self.batch_normalization3=batch_normalization(self.conv2d2.output_size,momentum=0.999,parallel=False,dtype=dtype)
...
class MobileNetV2:
    ...
    def build(self,dtype='float32'):
        ...
        self.layers.add(batch_normalization(momentum=0.999,parallel=False,dtype=dtype))
