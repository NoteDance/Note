...
class _conv_block:
    def __init__(self, in_channels, filters, alpha, kernel=(3, 3), strides=[1, 1], dtype='float32'):
        ...
        self.batch_norm=batch_normalization(self.conv2d.output_size,parallel=False,dtype=dtype)
...
class _depthwise_conv_block:
    def __init__(self,in_channels,pointwise_conv_filters,alpha,depth_multiplier=1,strides=[1, 1],block_id=1,dtype='float32'):
        ...
        self.batch_norm1=batch_normalization(self.depthwiseconv2d.output_size,parallel=False,dtype=dtype)
        ...
        self.batch_norm2=batch_normalization(self.conv2d.output_size,parallel=False,dtype=dtype)
        self.train_flag=True
        self.output_size=self.conv2d.output_size
