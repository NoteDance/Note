...
class EfficientNetB2:
    ...
    def build(self,dtype='float32'):
        ...
        self.MBConv1=MBConv(64,24,3,1,1,1,dtype) # create a MBConv layer with 24 output channels and 1 repeat
        self.MBConv2=MBConv(24,48,3,2,6,4,dtype) # create a MBConv layer with 48 output channels and 4 repeats
        self.MBConv3=MBConv(48,64,5,2,6,2,dtype) # create a MBConv layer with 64 output channels and 2 repeats
        self.MBConv4=MBConv(64,120,3,2,6,4,dtype) # create a MBConv layer with 120 output channels and 4 repeats
        self.MBConv5=MBConv(120,160,5,1,6,4,dtype) # create a MBConv layer with 160 output channels and 4 repeats
        self.MBConv6=MBConv(160,256,5,2,6,5,dtype) # create a MBConv layer with 256 output channels and 5 repeats
        self.MBConv7=MBConv(256,448,3,1,6,1,dtype) # create a MBConv layer with 448 output channels and 1 repeat
        self.dense=dense([448,self.classes],dtype=dtype) # create a dense layer with self.classes units
