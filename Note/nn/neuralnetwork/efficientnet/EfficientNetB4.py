...
class EfficientNetB4:
    ...
    def build(self,dtype='float32'):
        ...
        self.MBConv1=MBConv(112,40,3,1,1,1,dtype) # create a MBConv layer with 40 output channels and 1 repeat
        self.MBConv2=MBConv(40,80,3,2,6,6,dtype) # create a MBConv layer with 80 output channels and 6 repeats
        self.MBConv3=MBConv(80,128,5,2,6,2,dtype) # create a MBConv layer with 128 output channels and 2 repeats
        self.MBConv4=MBConv(128,224,3,2,6,6,dtype) # create a MBConv layer with 224 output channels and 6 repeats
        self.MBConv5=MBConv(224,272,5,1,6,6,dtype) # create a MBConv layer with 272 output channels and 6 repeats
        self.MBConv6=MBConv(272,448,5,2,6,8,dtype) # create a MBConv layer with 448 output channels and 8 repeats
        self.MBConv7=MBConv(448,704,3,1,6,1,dtype) # create a MBConv layer with 704 output channels and 1 repeat
        self.dense=dense([704,self.classes],dtype=dtype) # create a dense layer with self.classes units
