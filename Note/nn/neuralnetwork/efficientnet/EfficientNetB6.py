...
class EfficientNetB6:
    ...
    def build(self,dtype='float32'):
        ...
        self.conv2d=conv2d(208,[3,3],3,strides=[1,2,2,1],padding="SAME",dtype=dtype) # create a conv2d layer with 208 filters and no bias
        ...
        self.conv1x1=conv2d(1280,[1,1],1152,strides=[1,1,1,1],padding="SAME",dtype=dtype) # create a conv2d layer with 1280 filters and no bias
