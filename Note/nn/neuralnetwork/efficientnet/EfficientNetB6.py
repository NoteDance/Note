...
class EfficientNetB6:
    ...
    def build(self,dtype='float32'):
        ...
        self.MBConv1=MBConv(208,56,3,1,1,1,dtype) # create a MBConv layer with 56 output channels and 1 repeat
        self.MBConv2=MBConv(56,120,3,2,6,9,dtype) # create a MBConv layer with 120 output channels and 9 repeats
        self.MBConv3=MBConv(120,200,5,2,6,2,dtype) # create a MBConv layer with 200 output channels and 2 repeats
        self.MBConv4=MBConv(200,344,3,2,6,9,dtype) # create a MBConv layer with 344 output channels and 9 repeats
        self.MBConv5=MBConv(344,456,5,1,6,9,dtype) # create a MBConv layer with 456 output channels and 9 repeats
        self.MBConv6=MBConv(456,680,5,2,6,12,dtype) # create a MBConv layer with 680 output channels and 12 repeats
        self.MBConv7=MBConv(680,1152,3,1,6,1,dtype) # create a MBConv layer with 1152 output channels and 1 repeat
        self.dense=dense([1152,self.classes],dtype=dtype) # create a dense layer with self.classes units
