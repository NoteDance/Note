...
class EfficientNetB5:
    ...
    def build(self,dtype='float32'):
        ...
        self.MBConv1=MBConv(160,48,3,1,1,1,dtype) # create a MBConv layer with 48 output channels and 1 repeat
        self.MBConv2=MBConv(48,104,3,2,6,8,dtype) # create a MBConv layer with 104 output channels and 8 repeats
        self.MBConv3=MBConv(104,176,5,2,6,2,dtype) # create a MBConv layer with 176 output channels and 2 repeats
        self.MBConv4=MBConv(176,304,3,2,6,8,dtype) # create a MBConv layer with 304 output channels and 8 repeats
        self.MBConv5=MBConv(304,384,5,1,6,8,dtype) # create a MBConv layer with 384 output channels and 8 repeats
        self.MBConv6=MBConv(384,576,5,2,6,10,dtype) # create a MBConv layer with 576 output channels and 10 repeats
        self.MBConv7=MBConv(576,960,3,1,6,1,dtype) # create a MBConv layer with 960 output channels and 1 repeat
        self.dense=dense([960,self.classes],dtype=dtype) # create a dense layer with self.classes units
