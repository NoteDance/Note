...
class EfficientNetB5:
    ...
    def build(self,dtype='float32'):
        ...
        self.conv2d=conv2d([3,3,3,160],dtype=dtype) # create a conv2d layer with 160 filters and no bias
        self.MBConv1=MBConv(160,48,3,1,1,1,model_number=5,dtype=dtype) # create a MBConv layer with 48 output channels and 1 repeat
        self.MBConv2=MBConv(48,104,3,2,6,8,model_number=5,dtype=dtype) # create a MBConv layer with 104 output channels and 8 repeats
        self.MBConv3=MBConv(104,176,5,2,6,2,model_number=5,dtype=dtype) # create a MBConv layer with 176 output channels and 2 repeats
        self.MBConv4=MBConv(176,304,3,2,6,8,model_number=5,dtype=dtype) # create a MBConv layer with 304 output channels and 8 repeats
        self.MBConv5=MBConv(304,384,5,1,6,8,model_number=5,dtype=dtype) # create a MBConv layer with 384 output channels and 8 repeats
        self.MBConv6=MBConv(384,576,5,2,6,10,model_number=5,dtype=dtype) # create a MBConv layer with 576 output channels and 10 repeats
        self.MBConv7=MBConv(576,960,3,1,6,1,model_number=5,dtype=dtype) # create a MBConv layer with 960 output channels and 1 repeat
        self.conv1x1=conv2d([1,1,960,1280],dtype=dtype) # create a conv2d layer with 1280 filters and no bias
