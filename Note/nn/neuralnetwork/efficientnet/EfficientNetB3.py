...
class EfficientNetB3:
    ...
    def build(self,dtype='float32'):
        ...
        self.conv2d=conv2d([3,3,3,80],strides=[1,2,2,1],padding="SAME",dtype=dtype) # create a conv2d layer with 80 filters and no bias
        ...
        self.conv1x1=conv2d([1,1,512,1280],strides=[1,1,1,1],padding="SAME",dtype=dtype) # create a conv2d layer with 1280 filters and no bias
