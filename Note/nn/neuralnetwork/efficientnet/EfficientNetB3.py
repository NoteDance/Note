...
class EfficientNetB3:
    ...
    def build(self,dtype='float32'):
        ...
        self.conv2d=conv2d(80,[3,3],3,strides=[1,2,2,1],padding="SAME",dtype=dtype) # create a conv2d layer with 80 filters and no bias
        self.MBConv1=MBConv(80,32,3,1,1,1,dtype=dtype) # create a MBConv layer with 32 output channels and 1 repeat
        self.MBConv2=MBConv(32,56,3,2,6,5,dtype=dtype) # create a MBConv layer with 56 output channels and 5 repeats
        self.MBConv3=MBConv(56,88,5,2,6,2,dtype=dtype) # create a MBConv layer with 88 output channels and 2 repeats
        self.MBConv4=MBConv(88,152,3,2,6,5,dtype=dtype) # create a MBConv layer with 152 output channels and 5 repeats
        self.MBConv5=MBConv(152,208,5,1,6,5,dtype=dtype) # create a MBConv layer with 208 output channels and 5 repeats
        self.MBConv6=MBConv(208,320,5,2,6,6,dtype=dtype) # create a MBConv layer with 320 output channels and 6 repeats
        self.MBConv7=MBConv(320,512,3,1,6,1,dtype=dtype) # create a MBConv layer with 512 output channels and 1 repeat
        self.conv1x1=conv2d(1280,[1,1],512,strides=[1,1,1,1],padding="SAME",dtype=dtype) # create a conv2d layer with 1280 filters and no bias
