...
class EfficientNetB1:
    ...
    def build(self,dtype='float32'):
        ...
        self.conv2d=conv2d(48,[3,3],3,strides=[1,2,2,1],padding="SAME",dtype=dtype) # create a conv2d layer with 48 filters and no bias
        ...
        self.MBConv4=MBConv(48,88,3,2,6,4,dtype=dtype) # create a MBConv layer with 88 output channels and 4 repeats
        ...
        self.conv1x1=conv2d(1280,[1,1],352,strides=[1,1,1,1],padding="SAME",dtype=dtype) # create a conv2d layer with 1280 filters and no bias
