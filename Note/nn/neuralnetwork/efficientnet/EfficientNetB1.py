...
class EfficientNetB1:
    ...
    def build(self,dtype='float32'):
        ...
        self.MBConv1=MBConv(48,24,3,1,1,1,dtype) # create a MBConv layer with 24 output channels and 1 repeat
        self.MBConv2=MBConv(24,32,3,2,6,4,dtype) # create a MBConv layer with 32 output channels and 4 repeats
        self.MBConv3=MBConv(32,48,5,2,6,2,dtype) # create a MBConv layer with 48 output channels and 2 repeats
        self.MBConv4=MBConv(48,88,3,2,6,4,dtype) # create a MBConv layer with 88 output channels and 4 repeats
        self.MBConv5=MBConv(88,120,5,1,6,4,dtype) # create a MBConv layer with 120 output channels and 4 repeats
        self.MBConv6=MBConv(120,208,5,2,6,4,dtype) # create a MBConv layer with 208 output channels and 4 repeats
        self.MBConv7=MBConv(208,352,3,1,6,1,dtype) # create a MBConv layer with 352 output channels and 1 repeat
        self.dense=dense([352,self.classes],dtype=dtype) # create a dense layer with self.classes units
