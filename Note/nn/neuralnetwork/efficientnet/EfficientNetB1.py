...
class EfficientNetB1:
    """A class that implements the EfficientNetB1 model for image classification.
    ...
    def build(self,dtype='float32'):
        ...
        self.MBConv1=MBConv(48,24,3,1,1,1,model_number=1,dtype=dtype) # create a MBConv layer with 24 output channels and 1 repeat
        self.MBConv2=MBConv(24,32,3,2,6,4,model_number=1,dtype=dtype) # create a MBConv layer with 32 output channels and 4 repeats
        self.MBConv3=MBConv(32,48,5,2,6,2,model_number=1,dtype=dtype) # create a MBConv layer with 48 output channels and 2 repeats
        self.MBConv4=MBConv(48,88,3,2,6,4,model_number=1,dtype=dtype) # create a MBConv layer with 88 output channels and 4 repeats
        self.MBConv5=MBConv(88,120,5,1,6,4,model_number=1,dtype=dtype) # create a MBConv layer with 120 output channels and 4 repeats
        self.MBConv6=MBConv(120,208,5,2,6,4,model_number=1,dtype=dtype) # create a MBConv layer with 208 output channels and 4 repeats
        self.MBConv7=MBConv(208,352,3,1,6,1,model_number=1,dtype=dtype) # create a MBConv layer with 352 output channels and 1 repeat
