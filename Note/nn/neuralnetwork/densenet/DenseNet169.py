...
# define a class for DenseNet169 model
class DenseNet169:
    ...
    def build(self):
        ...
        self.block3 = DenseBlock(input_channels=self.trans2.output_size,num_layers=32,
                                 growth_rate=self.growth_rate,
                                 dtype=self.dtype)
        ...
        self.trans3 = TransitionLayer(input_channels=self.block3.output_size,compression_factor=self.compression_factor,
         ...
         # number of layers equal to 32 and growth rate equal to growth rate attribute
        self.block4 = DenseBlock(input_channels=self.trans3.output_size,num_layers=32,
                                 growth_rate=self.growth_rate,
                                 dtype=self.dtype)
