...
class BertModel(object):
  ...
  config = Note.nn.neuralnetwork.non_parallel.BertConfig(vocab_size=32000, hidden_size=512,
    num_hidden_layers=8, num_attention_heads=6, intermediate_size=1024)

  model = Note.nn.neuralnetwork.non_parallel.BertModel(config=config, seq_length, is_training=True,
