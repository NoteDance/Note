...
class _inverted_res_block:
    def __init__(self, in_channels=None, expansion=None, stride=None, alpha=None, filters=None, block_id=None):
        ...
        self.batch_normalization1=batch_norm_(self.conv2d1.output_size,momentum=0.999,parallel=False)
        ...
        self.batch_normalization2=batch_norm_(self.depthwiseconv2d.output_size,momentum=0.999,parallel=False)
        ...
        self.batch_normalization3=batch_norm_(self.conv2d2.output_size,momentum=0.999,parallel=False)
...
class MobileNetV2(Model):
    def __init__(self,alpha=1.0,classes=1000,include_top=True,pooling=None):
        ...
        self.layers.add(batch_norm_(momentum=0.999,parallel=False))
