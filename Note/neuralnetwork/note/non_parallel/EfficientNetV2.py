...
class EfficientNetV2(Model):
    ...
    def __init__(
        ...
        self.layers1.add(batch_norm_(axis=-1,momentum=self.bn_momentum,parallel=False))
        ...
        self.layers3.add(batch_norm_(axis=-1,momentum=self.bn_momentum,parallel=False))
