...
class Bottleneck:
    ...
    def __init__(self, inplanes, planes, stride=1):
        ...
        self.bn3 = batch_norm_(planes * self.expansion, parallel=False)
...
class CLIP(Module):
    def __init__(self,
        ...
        Model.param.append(self.logit_scale)
