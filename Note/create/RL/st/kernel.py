...
class kernel:
    ...
    def set_up(self,parameter=None,optimizer=None,epsilon=None,discount=None,episode_step=None,pool_size=None,batch=None,update_step=None,lr=None,init=False):
        if parameter!=None:
