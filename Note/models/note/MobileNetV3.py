...
class _inverted_res_block:
    def __init__(self, in_channels, expansion, filters, kernel_size, stride, se_ratio, activation, block_id):
        ...
        self.batch_normalization1=batch_norm_(self.conv2d1.output_size,epsilon=1e-3,momentum=0.999)
        if stride == 2:
        ...
        self.batch_normalization2=batch_norm_(self.depthwiseconv2d.output_size,epsilon=1e-3,momentum=0.999)
        if se_ratio:
        ...
        self.batch_normalization3=batch_norm_(self.conv2d2.output_size,epsilon=1e-3,momentum=0.999)
