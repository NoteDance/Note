...
# Layer modules:
**The usage of the layer module is similar to pytorch, which is to create an object first and then get the output, but the output of the layer module in Note needs to call the output method. To use the layer module, you first need to create a layer object, then call the output method to pass in the data and get the output.**
